export default function Comunidade() {
  return (
    <div className="relative min-h-screen px-6 md:px-16 py-16 fade">
      <h1 className="text-5xl font-bold neon mb-10 text-center">Comunidade</h1>
      ...
      <section className="max-w-3xl mx-auto fade">
        <div className="p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            A comunidade ainda está sendo reunida. Em breve, um lugar para discutir teorias e trocar histórias.
          </p>
        </div>
      </section>
    </div>
